...
OUTPUT_PATH = RAW_ABS_DIR / "wages_raw.xlsx"
...
def main() -> None:
    ...
    try:
        ...
        logger.warning("Failed to download wages raw from %s: %s", url, e)
        logger.warning("Skipping wages download. You can place the raw file manually in %s", OUTPUT_PATH)